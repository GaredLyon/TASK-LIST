...
// select elements
const elements = {
    btnSubmit: document.querySelector(".todo-form__btn"),
    inputTodo: document.querySelector(".todo-form__input"),
...
const todos = JSON.parse(localStorage.getItem("todos") || "[]"); //(c)[3] "Todo[]", "JSON.parse()", "localStorage.getItem()"
